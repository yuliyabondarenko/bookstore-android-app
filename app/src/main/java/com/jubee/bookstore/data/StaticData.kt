...
object StaticData {
    var BOOK_ITEMS: List<BookModel> = listOf(
        BookModel(1, "Юлий Алкин \"Цена познания\"", "http://fb2-epub.ru/Fantstic/Alkin/Tsiena_poznaniia-Iurii_Alkin.jpg", false, 12.3),
        BookModel(2, "Оноре де Бальзак \"Тридцатилетняя женщина\"", "http://irecommend.ru/sites/default/files/product-images/75276/ZtWWyVa21Kvl4bYJFfvg.jpg", true, 10.2),
        BookModel(3, "Трейси Брайан \"Оставьте брезгливость, съешьте лягушку!\"", "https://erudyt.com.ua/media/catalog/product/cache/1/image/9df78eab33525d08d6e5fb8d27136e95/1/0/1004187.jpg", true, 17.4),
        BookModel(4, "Рей Бредбери - \"451 градус по Фаренгейту\"", "http://loveread.ec/img/photo_books/2039.jpg", true, 53.34),
        BookModel(5, "Оскар Уайльд - \"Портрет Дориана Грея\"", "https://i1.rozetka.ua/goods/2449872/28944049_images_2449872889.jpg", true, 54.4),
        BookModel(6, "нтуан Франсуа Прево - \"История кавалера де Грие и Манон Леско\"", "https://i.livelib.ru/boocover/1000025434/200/ea35/AntuanFransua_Prevo__Istoriya_kavalera_de_Grie_i_Manon_Lesko.jpg", true, 11.44)
    )
}
...
//INSERT INTO book (id, name, price, photo)
//VALUES (5, 'Оскар Уайльд - "Портрет Дориана Грея"', 54.4, 'https://i1.rozetka.ua/goods/2449872/28944049_images_2449872889.jpg');
//INSERT INTO book (id, name, price, photo)
